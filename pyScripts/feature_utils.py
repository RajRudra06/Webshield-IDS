...
# add http/https to url if not present
...
#     'num_digits', 'num_letters', 'num_special_chars', 'has_ip',
#     'num_subdomains', 'has_multiple_subdomains', 'domain_length',
#     'host_entropy', 'domain_entropy', 'domain_has_digits',
#     'domain_digit_ratio', 'domain_vowel_ratio', 'domain_bigram_diversity',
#     'domain_trigram_diversity', 'suspicious_prefix_suffix',
#     'num_suspicious_symbols', 'subdomain_length', 'domain_is_dictionary_word',
#     'tld_length', 'tld_trust_category', 'is_suspicious_tld',
#     'is_high_trust_tld', 'is_country_tld', 'path_length',
#     'num_path_segments', 'num_query_params', 'query_length',
#     'num_encoded_chars', 'num_fragments', 'path_entropy',
#     'path_has_suspicious_ext', 'query_has_redirect', 'path_url_ratio',
#     'suspicious_word', 'num_suspicious_words', 'sensitive_word',
#     'action_word', 'has_brand_name', 'brand_not_in_domain',
#     'is_shortening_service', 'is_mixed_case', 'num_repeated_chars',
#     'longest_token_length', 'digit_letter_ratio', 'special_char_ratio',
#     'uppercase_ratio', 'consecutive_consonants', 'url_entropy', 'has_port',
#     'uses_https', 'punycode_domain', 'subdomain_count_dot', 'domain_url_ratio',
#     'query_url_ratio', 'brand_impersonation', 'brand_with_hyphen',
#     'is_typosquatting', 'typosquatting_similarity', 'has_character_substitution',
#     'suspicious_tld_brand_combo', 'multiple_brands_in_domain',
#     'brand_not_in_main_domain'
# ]
...
#             return {f: 0 for f in EXPECTED_FEATURE_NAMES}
#         parsed = urlparse(url)
#         ext = extract(url)
#         domain = ext.domain
#         subdomain = ext.subdomain
...
#         url = 'https://' + url  # Modern browser behavior

#     # Now uses_https will be True for "facebook.com"
#     # Both models will handle it correctly
#     return extract_features_enhanced(url)
