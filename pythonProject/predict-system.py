...
try:
    model = joblib.load('/Users/rudrarajpurohit/Desktop/pythonProject/phishing_model.pkl')
    with open('/Users/rudrarajpurohit/Desktop/pythonProject/feature_names.json', 'r') as f:
